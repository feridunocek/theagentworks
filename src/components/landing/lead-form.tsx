...
export function LeadForm() {
    ...
    return (
        <section id="iletisim" className="py-24 relative overflow-hidden">
            {/* Background Effects */}
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[var(--color-neon-purple)]/10 rounded-full blur-[120px] -z-10" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[var(--color-neon-cyan)]/10 rounded-full blur-[120px] -z-10" />
            ...
            <div className="container px-4 md:px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            {dict.lead_form.features.map((feature, index) => (
                                ...
                                >
                                    <div className="mt-1 p-2 rounded-lg bg-[var(--color-neon-cyan)]/10 text-[var(--color-neon-cyan)]">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <GlassCard className="p-8 md:p-10 border-white/10 relative overflow-hidden">
                            ...
                            {isSubmitted ? (
                                ...
                                <motion.div>
                                    <div className="flex items-center gap-3 mb-8">
                                        ...
                                        <h3 className="text-2xl font-bold text-white">{dict.lead_form.form.title}</h3>
                                    </div>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:outline-hidden focus:border-[var(--color-neon-cyan)]/50 focus:ring-1 focus:ring-[var(--color-neon-cyan)]/50 transition-all font-sans"
                                            />
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <select
                                                    id="department"
                                                    className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-hidden focus:border-[var(--color-neon-cyan)]/50 focus:ring-1 focus:ring-[var(--color-neon-cyan)]/50 transition-all appearance-none cursor-pointer font-sans"
                                                    defaultValue=""
                                                >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:outline-hidden focus:border-[var(--color-neon-cyan)]/50 focus:ring-1 focus:ring-[var(--color-neon-cyan)]/50 transition-all resize-none font-sans"
                                            />
                                        </div>

                                        <div className="pt-2">
                                            <NeonButton variant="primary" glow className="w-full py-4 text-lg justify-center group" disabled={isSubmitting}>
                                                {isSubmitting ? (
